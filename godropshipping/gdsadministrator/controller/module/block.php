...
class ControllerModuleBlock extends Controller {
	...
	public function index() {   
		...
		$this->data['action'] = $this->url->link('module/block', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['block_module'])) {
			$this->data['modules'] = $this->request->post['block_module'];
		} elseif ($this->config->get('block_module')) { 
			$this->data['modules'] = $this->config->get('block_module');
		}	
