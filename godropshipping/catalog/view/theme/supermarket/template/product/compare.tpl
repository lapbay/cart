  ...
  <table class="compare-info">
    ...
    <tbody>
      <tr>
        ...
        <td class="product-name">
            ...
            <div class="image"><?php if ($products[$product['product_id']]['thumb']) { ?>
            ...
            <div class="model"><?php echo $products[$product['product_id']]['model']; ?></div>
        </td>
        <?php } ?>
      </tr>
      <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/supermarket/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
    ...
    <tr>
        ...
        <td>
          ...
          <div class="price"><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button"><span><?php echo $button_cart; ?></span></a></div>
          </td>
        <?php } ?>
    </tr>
  </table>
  </div><!-- end frame-compare -->
  <div class="buttons">
