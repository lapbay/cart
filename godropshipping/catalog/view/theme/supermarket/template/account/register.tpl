  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="register">
    ...
    <div class="content">
      <table class="form">
        ...
        <tr>
          <td><span class="required">*</span> <?php echo $entry_email; ?></td></tr>
		  <tr>
    ...
    <div class="content">
      <table class="form">
        ...
        <tr>
          <td><span class="required">*</span> <?php echo $entry_postcode; ?></td></tr>
		  <tr>
    ...
    <div class="content">
      <table class="form">
        <tr>
          <td><span class="required">*</span> <?php echo $entry_password; ?></td></tr>
		  <tr>
        ...
        <tr>
          <td><span class="required">*</span> <?php echo $entry_confirm; ?></td></tr>
		  <tr>
    ...
    <div class="content">
      <table class="form">
        <tr>
          <td><?php echo $entry_newsletter; ?></td></tr>
		  <tr>
